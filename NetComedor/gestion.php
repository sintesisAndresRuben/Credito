				...
				<div class="col">
					...
					<div class="form-group row">
						...
						if ($_SESSION['user']['id_etapa']==15){
							...
							$sqlCantidad = "SELECT * FROM `tbl_usuario_ticket` WHERE para_usuario=".$_SESSION['user']['id_usuario'];
						}
						...
						if (mysqli_num_rows($result)>0) {
							while ($cantidad = (mysqli_fetch_array($result))){
								...
								<div class="col-12 col-sm">
									...
									<input type="number" class="form-control" id="cantidadTicket" value="<?php echo $tbl_Cantidad['cantidad']['cantidad_ticket'] ?>" required name="cantidadT" value="1" min="1" max="200" disabled>
									<?php
								}
							}
							?>
